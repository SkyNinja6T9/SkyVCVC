...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Mobilelegendsunofficialindia")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Mobilelegendsunofficialindia")
...
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "601"))
